...
public class TheClogsOfManicDepressive implements Listener {
	...
	public void customRecipe() {
		...
		meta.setDisplayName(ChatColor.LIGHT_PURPLE + "The Clogs Of Manic Depressive");
		...
		NamespacedKey key = new NamespacedKey(plugin, "Clogs");
